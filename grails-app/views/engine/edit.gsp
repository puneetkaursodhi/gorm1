                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="name"><g:message code="engine.name.label" default="Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: engineInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" value="${engineInstance?.name}" />
                                </td>
                            </tr>
